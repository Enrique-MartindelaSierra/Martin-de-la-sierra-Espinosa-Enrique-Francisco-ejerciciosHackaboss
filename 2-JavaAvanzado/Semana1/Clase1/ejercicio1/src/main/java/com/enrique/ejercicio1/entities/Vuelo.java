...
public class Vuelo {
    ...
    public Vuelo(String nombre, String destino, LocalDate fechaDeViaje, int numeroDeAsientos) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Vuelo{" + "nombre=" + nombre + ", destino=" + destino + ", fechaDeViaje=" + fechaDeViaje + ", numeroDeAsientos=" + numeroDeAsientos + '}';
    }
